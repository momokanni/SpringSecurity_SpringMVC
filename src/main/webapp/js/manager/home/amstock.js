(function() {
    ...
    d.AmStockChart = d.Class({
        ...
        write: function(a) {
            ...
            this.chartCursors = []; (c = this.exportConfig) && d.AmExport && !this.AmExport && (this.AmExport = new d.AmExport(this, c));
        ...
        measurePanels: function(a) {
            ...
            if (this.div) {
                ...
                b.enabled && (c -= b.height); (b = this.periodSelector) && !b.vertical && (b = b.offsetHeight, c -= b + d); (b = this.dataSetSelector) && !b.vertical && (b = b.offsetHeight, c -= b + d);
                ...
                if (c != this.prevPH) {
                    ...
                    for (var e = 0,
                    l, b = 0; b < a.length; b++) if (l = a[b]) {
                        var k = l.percentHeight;
                        isNaN(k) && (k = 100 / a.length, l.percentHeight = k);
                        e += k
                    }
                    this.panelsHeight = Math.max(c - d * (a.length - 1), 0);
                    for (b = 0; b < a.length; b++) if (l = a[b]) l.percentHeight = l.percentHeight / e * 100,
                    l.panelBox && (l.panelBox.style.height = Math.round(l.percentHeight * this.panelsHeight / 100) + "px");
                    this.prevPH = c
                }
            }
        },
        ...
        updatePanel: function(a) {
            ...
            e = c.length,
            f;
            0 === e && (f = new d.ValueAxis(this.theme), a.addValueAxis(f));
            ...
            e = c.length;
            for (b = 0; b < e; b++) f = c[b],
            d.copyProperties(this.valueAxesSettings, f);
            a.listenersAdded = !1;
            a.write(a.panelBox)
        },
        zoom: function(a, b) {
        ...
        addChartScrollbar: function() {
            ...
            if (a.enabled) {
                ...
                "bottom" == a.position ? c ? "bottom" == c.position ? f.insertBefore(k, e) : f.appendChild(k) : f.appendChild(k) : c ? "top" == c.position ? f.insertBefore(k, e.nextSibling) : f.insertBefore(k, f.firstChild) : f.insertBefore(k, f.firstChild);
                b.write(k)
            }
        },
        ...
        addPeriodSelector: function() {
            ...
            if (a) {
                ...
                case "top":
                    ...
                    break;
                case "bottom":
                    f.style.marginTop = c + "px",
                    "bottom" == e ? h.insertBefore(f, b) : h.appendChild(f)
                }
        ...
        hideChartCursor: function() {
            ...
            for (b = 0; b < a.length; b++) {
                var c = a[b];
                c.hideCursor(!1); (c = c.chart) && c.updateLegendValues()
            }
        },
        ...
        zoomChart: function(a, b) {
            ...
            if (f && l) {
                ...
                n = d.newDate(a);
                c.extendToFullPeriod && (n.getTime() - f.getTime() < .1 * z && (n = d.resetDateToMin(a, m.period, m.count, y)), l.getTime() - b.getTime() < .1 * z && (b = d.resetDateToMin(l, m.period, m.count, y), b = d.changeDate(b, m.period, m.count, !0)));
                for (f = 0; f < r.length; f++) l = r[f],
                l.chartCursor && l.chartCursor.panning && (n = e);
                for (f = 0; f < r.length; f++) {
                    l = r[f];
                    if (k != h) {
                        for (e = 0; e < u.length; e++) z = u[e].graph,
                        z.dataProvider = z.dataSet.agregatedDataProviders[k];
                        e = l.categoryAxis;
                        e.firstDayOfWeek = y;
                        e.minPeriod = k;
                        l.dataProvider = c.mainDataSet.agregatedDataProviders[k];
                        if (e = l.chartCursor) e.categoryBalloonDateFormat = c.chartCursorSettings.categoryBalloonDateFormat(m.period),
                        l.showCategoryAxis || (e.categoryBalloonEnabled = !1);
                ...
                c.animationPlayed = !0;
                g = d.newDate(b);
                x && c.updateScrollbar && (x.zoomToDates(a, g), c.skipScrollbarEvent = !0, setTimeout(function() {
                    c.resetSkip.call(c)
                },
                100));
                c.updateScrollbar = !0;
            ...
            if (0 < this.dataSets.length) {
                ...
                for (b = 0; b < a.length; b++) {
                    ...
                    for (k = 0; k < l.length; k++) {
                        ...
                        l[k] = g;
                        if (!g.title || g.resetTitleOnDataSetChange) g.title = e.title,
                        g.resetTitleOnDataSetChange = !0;
                        ...
                        for (h = 0; h < r.length; h++) {
                            m = r[h];
                            var u = g.valueField;
                            u && m.toField == u && (p = !0); (u = g.openField) && m.toField == u && (p = !0); (u = g.closeField) && m.toField == u && (p = !0); (u = g.lowField) && m.toField == u && (p = !0)
                        }
                        c.addGraph(g);
                        ...
                        if (g.comparable) {
                            ...
                            if (g.valueAxis) {
                                ...
                                for (E = 0; E < B; E++) {
                                    ...
                                    t.showBalloon = g.showBalloon;
                                    this.passFields(g, t);
                                    var v = g.compareField;
                                    v || (v = g.valueField);
                                    p = !1;
                                    r = C.fieldMappings;
                                    for (h = 0; h < r.length; h++) m = r[h],
                                    m.toField == v && (p = !0);
                                    if (p) {
                                        t.valueField = v;
                                        t.title = C.title;
                                        ...
                                        if (h = g.compareGraphNumberFormatter) t.numberFormatter = h;
        ...
        getSelections: function() {
            ...
            "never" != d.recalculateToPercents && 0 < a.length ? d.hideDrawingIcons(!0) : d.drawingIconsEnabled && d.hideDrawingIcons(!1)
        },
        addPanel: function(a) {
            this.panels.push(a);
            this.prevPH = void 0;
        ...
        showHideEvents: function(a) {
            ...
            for (c = 0; c < b.length; c++) {
                ...
                for (f = 0; f < d.length; f++) {
                    var l = d[f]; ! 0 === a ? l.showCustomBullets(!0) : l.hideCustomBullets(!0)
                }
            }
        },
    ...
    d.PeriodSelector = d.Class({
        ...
        write: function(a) {
            ...
            if (b.inputFieldsEnabled) {
                ...
                d.isNN && g.addEventListener("keypress",
                function(a) {
                    b.handleCalendarChange.call(b, a)
                },
                !0);
                d.isIE && g.attachEvent("onkeypress",
                function(a) {
                    b.handleCalendarChange.call(b, a)
                });
                h.appendChild(g);
            ...
            if (d.ifArray(h)) {
                ...
                r.count = g.count,
                r.periodObj = g,
                r.className = "amChartsButton " + c + "-period-input",
                e && d.applyStyles(r.style, e.PeriodButton),
                f && (r.style.width = b.width - 1 + "px"),
                r.style.boxSizing = "border-box",
                m.appendChild(r),
                b.addEventListeners(r),
                g.button = r; ! f && r && (k = r.offsetHeight)
            }
            b.offsetHeight = Math.max(l, k)
        },
        addEventListeners: function(a) {
            var b = this;
            d.isNN && a.addEventListener("click",
            function(a) {
                b.handlePeriodChange.call(b, a)
            },
            !0);
            d.isIE && a.attachEvent("onclick",
            function(a) {
                b.handlePeriodChange.call(b, a)
            })
        },
        ...
        selectPeriodButton: function(a, b, c) {
            ...
            a.startDate = h, a.endDate = m, a.predefinedPeriod = l, a.chart = this.chart, a.count = f, a.event = c, this.fire(a.type, a)))
        },
    ...
    d.StockPanel = d.Class({
        ...
        initChart: function(a) {
            ...
            this.drawingIconsEnabled && this.createDrawIcons(); (a = this.chartCursor) && this.listenTo(a, "draw", this.handleDraw)
        },
            ...
            for (p = 0; p < r; p++) {
                ...
                for (t = m; t < g; t++) {
                    ...
                    if (t == m || E >= x[u] || !x[u]) {
                        ...
                        var F;
                        for (F = 0; F < z; F++) v = n[F].toField,
                        w = y[u],
                        q = Number(C[v]),
                        w[v + "Count"] = 0,
                        isNaN(q) || (w[v + "Open"] = q, w[v + "Sum"] = q, w[v + "High"] = q, w[v + "AbsHigh"] = q, w[v + "Low"] = q, w[v + "Close"] = q, w[v + "Count"] = 1, w[v + "Average"] = q);
                        w.dataContext = A;
                        l[u].push(y[u]);
                        ...
                        y[u][h] = d.newDate(B, b)
                    } else for (D = 0; D < z; D++) v = n[D].toField,
                    w = y[u],
                    p == r - 1 && (w[h] = d.newDate(B, b)),
                    q = Number(C[v]),
                    isNaN(q) || (isNaN(w[v + "Low"]) && (w[v + "Low"] = q), q < w[v + "Low"] && (w[v + "Low"] = q), isNaN(w[v + "High"]) && (w[v + "High"] = q), q > w[v + "High"] && (w[v + "High"] = q), isNaN(w[v + "AbsHigh"]) && (w[v + "AbsHigh"] = q), Math.abs(q) > w[v + "AbsHigh"] && (w[v + "AbsHigh"] = q), w[v + "Close"] = q, G = d.getDecimals(w[v + "Sum"]), F = d.getDecimals(q), isNaN(w[v + "Sum"]) && (w[v + "Sum"] = 0), w[v + "Sum"] += q, w[v + "Sum"] = d.roundTo(w[v + "Sum"], Math.max(G, F)), w[v + "Count"]++, w[v + "Average"] = w[v + "Sum"] / w[v + "Count"])
                }
            }
        }
    ...
    d.parseEvents = function(a, b, c, e, f, l) {
        ...
        for (g = 0; g < m; g++) {
            ...
            var B;
            for (p = 0; p < r; p++) u = x[p],
            u.customBulletField = "amCustomBullet" + u.id + "_" + y.id,
            u.bulletConfigField = "amCustomBulletConfig" + u.id + "_" + y.id;
        ...
        for (var E in h) if (h.hasOwnProperty(E)) {
            ...
            for (v = 0; v < t; v++) {
                ...
                for (g = 0; g < m; g++) for (y = b[g], x = y.graphs, r = x.length, p = 0; p < r; p++) {
                    u = x[p];
                    var q = {};
                    q.eventDispatcher = f;
                    q.eventObjects = [];
                    ...
                    for (A = 0; A < k.length; A++) {
                        ...
                        0 < q.shapes.length && (n = "amCustomBullet" + u.id + "_" + y.id, z = "amCustomBulletConfig" + u.id + "_" + y.id, D[n] = d.StackedBullet, D[z] = q)
                    }
                }
            }
        }
    ...
    d.DataSetSelector = d.Class({
        ...
        write: function(a) {
            ...
            if (1 < b.countDataSets("showInSelect")) {
                ...
                a.appendChild(p);
                d.isNN && p.addEventListener("change",
                function(a) {
                    b.handleDataSetChange.call(b, a)
                },
                !0);
                d.isIE && p.attachEvent("onchange",
                function(a) {
                    b.handleDataSetChange.call(b, a)
                });
            ...
            if (0 < b.countDataSets("showInCompare") && 1 < l.length) if (k ? (d.addBr(a), d.addBr(a)) : (c = document.createTextNode(" "), a.appendChild(c)), c = document.createTextNode(d.lang.compareText || b.compareText), a.appendChild(c), g = b.listCheckBoxSize, k) {
                ...
                e && d.applyStyles(h.style, e.DataSetCompareList);
                h.style.overflow = "auto";
                h.style.overflowX = "hidden";
                h.style.width = b.width - 2 + "px";
                h.style.maxHeight = b.listHeight + "px";
                for (c = 0; c < l.length; c++) m = l[c],
                !0 === m.showInCompare && m != b.chart.mainDataSet && (e = document.createElement("div"), e.style.padding = "4px", e.style.position = "relative", e.name = "amCBContainer", e.className = f.classNamePrefix + "-compare-item-div", e.dataSet = m, e.style.height = g + "px", m.compared && (e.style.backgroundColor = b.selectedBackgroundColor), h.appendChild(e), k = document.createElement("div"), k.style.width = g + "px", k.style.height = g + "px", k.style.position = "absolute", k.style.backgroundColor = m.color, e.appendChild(k), k = document.createElement("div"), k.style.width = "100%", k.style.position = "absolute", k.style.left = g + 10 + "px", e.appendChild(k), m = document.createTextNode(m.title), k.style.whiteSpace = "nowrap", k.style.cursor = "default", k.appendChild(m), b.addEventListeners(e));
                d.addBr(a);
                d.addBr(a)
            } else {
        ...
        addEventListeners: function(a) {
            var b = this;
            d.isNN && (a.addEventListener("mouseover",
            function(a) {
            ...
            !0));
            d.isIE && (a.attachEvent("onmouseout",
            function(a) {
                b.handleRollOut.call(b, a)
        ...
        handleClick: function(a) {
            a = this.getRealDiv(a).dataSet; ! 0 === a.compared ? (a.compared = !1, a = {
                type: "dataSetUncompared",
                dataSet: a
            }) : (a.compared = !0, a = {
                type: "dataSetCompared",
    ...
    d.StackedBullet = d.Class({
        ...
        write: function(a) {
            ...
            b = this.letters.length; (this.mastHeight + 2 * (this.fontSize / 2 + 2)) * b > this.availableSpace && (this.stackDown = !0);
            this.set = a.set();
            this.cset = a.set();
        ...
        addLetter: function(a, b, c) {
            ...
            this.bullets[c] = n;
            this.showOnAxis ? (p = isNaN(this.nextAxisY) ? this.axisCoordinate: this.nextY, g = h * f, this.nextAxisY = p + f * e) : this.value ? (p = this.value, k.recalculateToPercents && (p = p / k.recBaseValue * 100 - 100), p = k.getCoordinate(p) - this.bulletY, g = h * f) : this.showAt ? (n = this.graphDataItem.values, k.recalculateToPercents && (n = this.graphDataItem.percents), n && (p = k.getCoordinate(n[this.showAt]) - this.bulletY, g = h * f)) : (p = this.nextY, g = h * f);
            a.translate(m, g);
            b.push(a);
            b.translate(0, p);
        ...
        handleMouseOver: function(a, b) {
            ...
            this.chart.showBalloon(d.fixNewLines(c.description), f.stockEventsSettings.balloonColor, !0)
        },
        handleClick: function(a) {
