(function() {
    ...
    l.AmPieChart = l.Class({
        ...
        drawChart: function() {
            ...
            if (l.ifArray(d)) {
                if (0 < this.realWidth && 0 < this.realHeight) {
                    ...
                    360 < m && (m -= 360);
                    b = k - k * this.angle / 90;
                    for (f = p = 0; f < d.length; f++) a = d[f],
                    !0 !== a.hidden && (p += l.roundTo(a.percents, this.pf.precision));
                    ...
                    for (var D, f = 0; f < d.length; f++) if (a = d[f], !0 !== a.hidden && (this.showZeroSlices || 0 !== a.percents)) {
                        ...
                        if (this.labelsEnabled && this.labelText && a.percents >= this.hideLabelsPercent) {
                            ...
                            h = this.formatString(this.labelText, a); (r = this.labelFunction) && (h = r(a, h));
                            r = a.labelColor;
                            r || (r = this.color);
                            if ("" !== h) {
                                ...
                                a.textX = t + 1.5 * u;
                                var r = h.getBBox(),
                                F = l.rect(c, r.width + 5, r.height + 5, "#FFFFFF", .005);
                        ...
                        if (0 === a.alpha || 0 < g && !this.chartCreated) q.hide(),
                        w && w.hide();
        ...
        arrangeLabels: function() {
            ...
            g = d.length,
            c, b;
            for (b = g - 1; 0 <= b; b--) c = d[b],
            0 !== c.labelQuarter || c.hidden || this.checkOverlapping(b, c, 0, !0, 0);
            for (b = 0; b < g; b++) c = d[b],
            1 != c.labelQuarter || c.hidden || this.checkOverlapping(b, c, 1, !1, 0);
            for (b = g - 1; 0 <= b; b--) c = d[b],
            2 != c.labelQuarter || c.hidden || this.checkOverlapping(b, c, 2, !0, 0);
            for (b = 0; b < g; b++) c = d[b],
            3 != c.labelQuarter || c.hidden || this.checkOverlapping(b, c, 3, !1, 0)
        },
        checkOverlapping: function(d, g, c, b, l) {
            ...
            m = g.label;
            if (m) {
                if (!0 === b) for (f = d + 1; f < v; f++) a[f].labelQuarter == c && (e = this.checkOverlappingReal(g, a[f], c)) && (f = v);
                else for (f = d - 1; 0 <= f; f--) a[f].labelQuarter == c && (e = this.checkOverlappingReal(g, a[f], c)) && (f = 0); ! 0 === e && 100 > l && isNaN(g.labelRadius) && (e = g.ty + 3 * g.iy, g.ty = e, m.translate(g.textX, e), g.hitRect && (m = m.getBBox(), g.hitRect.translate(g.tx2, e + m.y)), this.checkOverlapping(d, g, c, b, l + 1))
            }
        },
        checkOverlappingReal: function(d, g, c) {
            ...
            n = d.label,
            e = g.label;
            d.labelQuarter != c || d.hidden || g.hidden || !e || (n = n.getBBox(), c = {},
            c.width = n.width, c.height = n.height, c.y = d.ty, c.x = d.tx, d = e.getBBox(), e = {},
            e.width = d.width, e.height = d.height, e.y = g.ty, e.x = g.tx, l.hitTest(c, e) && (b = !0));
            return b
        }
    })
})();