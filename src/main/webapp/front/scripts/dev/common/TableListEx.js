...
QNR.TableList=(function(){
    ...
    q.TableList = {
        ...
        drawTotalHeader : function(d) {
        	...
        	ctrs.push("<table id='tablelist_header_table' width='100%' cellspacing='0' cellpadding='0' border='0' style='margin-top:10px;margin-bottom:10px'>");
        	...
        	if (self.setting.totalHeaderPos == "before") {
        		$('.psell_table').before(ctrs.join(""));
        	} else {
