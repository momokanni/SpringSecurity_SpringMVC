...
<jsp:include page="/blogPlatform/common/leftMenu.jsp"/>
	...
	<form id="arForm" action="#" method="post">
		<input type="hidden" id="arIdInp" name="id" value="<%= arId %>"/>
		        ...
		        <div class="pd30 rel_srk">
					...
					<security:authorize access="hasRole('SCST')">
			            <div class="screen_inp mt15" style="height:200px">
			                <span class="fl ft14 colgblock">设置封面：</span>
			               	...
			               	<input id="thumbPath" type="hidden" value="" name="thumb" value=" "/>
		            ...
		            <security:authorize access="hasRole('FXZWZBJMK')">
		            	<security:authorize access="hasRole('SCYP')">
				            <div class="screen_inp mt15" style="height:70px">
			             ...
			             <div class="screen_inp">
			                ...
			                <input id="shareContentInp" type="text" name="shareContent" value="" class="inputbox" style="width:70%"/>
			             </div>
			             
			             <input id="imgCountInp" type="hidden" name="imgCount" value="" class="inputbox" />
			             <input id="wordCountInp" type="hidden" name="wordCount" value="0" class="inputbox" />
			             ...
			             <div class="screen_inp mt10">
		                    ...
		                    %>
			                	<input type="checkbox" class="" name="otherStatus" id="keyword<%=keyWord.getId() %>" value="<%=keyWord.getId() %>" style="border:1px solid blue;width:15px;height:15px;-webkit-appearance:checkbox;"/>
...
<script type="text/javascript" src="/front/scripts/<%=Config.FRONT_PREFIX %>/blogPlatform/articleEdit.js?<%@include file='/include/.ver'%>"></script>
...
function minDate(){
	...
	$(function(){
		...
		//原始首图路径
		setTimeout(function() {
			originPath = $(".img-responsive").attr("src");
		},1000);
             ...
             success:function(data){
            	 if (1 == data.ret) {
                    ...
                    $(".img-responsive").attr("src",data.data);
                	 ...
                	 $(".img-responsive").attr("src",originPath);
                 }
             },
             error:function(data){
             }
