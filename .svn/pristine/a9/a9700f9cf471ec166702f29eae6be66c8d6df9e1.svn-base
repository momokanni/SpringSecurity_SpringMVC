(function() {
    ...
    e.AmSerialChart = e.Class({
            ...
            if (0 < this.realWidth && 0 < this.realHeight) {
                ...
                if (e.ifArray(a)) {
                    ...
                    if (b.parseDates && !b.equalSpacing) {
                        if (b = this.startTime, c = this.endTime, isNaN(b) || isNaN(c)) b = this.firstTime,
                        c = this.lastTime
                    } else if (b = this.start, c = this.end, isNaN(b) || isNaN(c)) b = 0,
                    c = a;
        ...
        zoomAxesAndGraphs: function() {
            if (!this.scrollbarOnly) {
                ...
                a = this.graphs;
                for (b = 0; b < a.length; b++) a[b].zoom(this.start, this.end);
                this.zoomTrendLines(); (b = this.chartCursor) && b.zoom && b.zoom(this.start, this.end, this.startTime, this.endTime)
            }
        },
        countColumns: function() {
            ...
            for (k = 0; k < b; k++) {
                e = this.valueAxes[k];
                var m = e.stackType;
                if ("100%" == m || "regular" == m) for (h = !1, g = 0; g < c; g++) d = this.graphs[g],
                d.tcc = 1,
                d.valueAxis == e && "column" == d.type && (!h && d.stackable && (a++, h = !0), (!d.stackable && d.clustered || d.newStack) && a++, d.columnIndex = a - 1, d.clustered || (d.columnIndex = 0));
                if ("none" == m || "3d" == m) {
                    h = !1;
                    for (g = 0; g < c; g++) d = this.graphs[g],
                    d.valueAxis == e && "column" == d.type && (d.clustered ? (d.tcc = 1, d.newStack && (a = 0), d.hidden || (d.columnIndex = a, a++)) : d.hidden || (h = !0, d.tcc = 1, d.columnIndex = 0));
                    h && 0 === a && (a = 1)
                }
                if ("3d" == m) {
                    e = 1;
                    for (k = 0; k < c; k++) d = this.graphs[k],
                    d.newStack && e++,
                    d.depthCount = e,
                    d.tcc = a;
                    a = e
        ...
        formatString: function(a, b, c) {
            ...
            f = d.numberFormatter;
            f || (f = this.nf);
            h = b.graph.valueAxis; (g = h.duration) && !isNaN(b.values.value) && (g = e.formatDuration(b.values.value, g, "", h.durationUnits, h.maxInterval, f), a = a.replace(RegExp("\\[\\[value\\]\\]", "g"), g));
    ...
    e.Cuboid = e.Class({
        ...
        draw: function() {
            ...
            if (0 < Math.abs(h) || 0 < Math.abs(g)) if (isNaN(r)) F = v,
            v = e.adjustLuminosity(A, -.2),
            v = e.adjustLuminosity(A, -.2),
            u = e.polygon(b, [0, h, d + h, d, 0], [0, g, g, 0, 0], v, m, 1, p, 0, n),
            0 < q && (M = e.line(b, [0, h, d + h], [0, g, g], p, q, l, y)),
            B = e.polygon(b, [0, 0, d, d, 0], [0, f, f, 0, 0], v, m, 1, p, 0, n),
            B.translate(h, g),
            0 < q && (C = e.line(b, [h, h], [g, g + f], p, q, l, y)),
            I = e.polygon(b, [0, 0, h, h, 0], [0, f, f + g, g, 0], v, m, 1, p, 0, n),
            z = e.polygon(b, [d, d, d + h, d + h, d], [0, f, f + g, g, 0], v, m, 1, p, 0, n),
            0 < q && (D = e.line(b, [d, d + h, d + h, d], [0, g, f + g, f], p, q, l, y)),
            v = e.adjustLuminosity(F, .2),
            F = e.polygon(b, [0, h, d + h, d, 0], [f, f + g, f + g, f, f], v, m, 1, p, 0, n),
            0 < q && (L = e.line(b, [0, h, d + h], [f, f + g, f + g], p, q, l, y));
            else {
                var N, O, P;
                K ? (N = f / 2, v = h / 2, P = f / 2, O = d + h / 2, G = Math.abs(f / 2), E = Math.abs(h / 2)) : (v = d / 2, N = g / 2, O = d / 2, P = f + g / 2 + 1, E = Math.abs(d / 2), G = Math.abs(g / 2));
                H = E * r;
                J = G * r;.1 < E && .1 < E && (u = e.circle(b, E, A, m, l, p, q, !1, G), u.translate(v, N));.1 < H && .1 < H && (F = e.circle(b, H, e.adjustLuminosity(A, .5), m, l, p, q, !1, J), F.translate(O, P))
            }
            m = Q;
            1 > Math.abs(f) && (f = 0);
            1 > Math.abs(d) && (d = 0); ! isNaN(r) && (0 < Math.abs(h) || 0 < Math.abs(g)) ? (k = [A], k = {
                fill: k,
                stroke: p,
                "stroke-width": l,
                "stroke-opacity": q,
            ...
            K ? (m = "M0,0 L" + d + "," + (f / 2 - f / 2 * r), l = " B", 0 < d && (l = " A"), e.VML ? (m += l + Math.round(d - H) + "," + Math.round(f / 2 - J) + "," + Math.round(d + H) + "," + Math.round(f / 2 + J) + "," + d + ",0," + d + "," + f, m = m + (" L0," + f) + (l + Math.round( - E) + "," + Math.round(f / 2 - G) + "," + Math.round(E) + "," + Math.round(f / 2 + G) + ",0," + f + ",0,0")) : (m += "A" + H + "," + J + ",0,0,0," + d + "," + (f - f / 2 * (1 - r)) + "L0," + f, m += "A" + E + "," + G + ",0,0,1,0,0"), E = 90) : (l = d / 2 - d / 2 * r, m = "M0,0 L" + l + "," + f, e.VML ? (m = "M0,0 L" + l + "," + f, l = " B", 0 > f && (l = " A"), m += l + Math.round(d / 2 - H) + "," + Math.round(f - J) + "," + Math.round(d / 2 + H) + "," + Math.round(f + J) + ",0," + f + "," + d + "," + f, m += " L" + d + ",0", m += l + Math.round(d / 2 + E) + "," + Math.round(G) + "," + Math.round(d / 2 - E) + "," + Math.round( - G) + "," + d + ",0,0,0") : (m += "A" + H + "," + J + ",0,0,0," + (d - d / 2 * (1 - r)) + "," + f + "L" + d + ",0", m += "A" + E + "," + G + ",0,0,1,0,0"), E = 180), b = b.path(m).attr(k), b.gradient("linearGradient", [A, e.adjustLuminosity(A, -.3), e.adjustLuminosity(A, -.3), A], E), K ? b.translate(h / 2, 0) : b.translate(0, g / 2)) : b = 0 === f ? e.line(b, [0, d], [0, 0], p, q, l, y) : 0 === d ? e.line(b, [0, 0], [0, f], p, q, l, y) : 0 < x ? e.rect(b, d, f, k, m, l, p, q, x, n, y) : e.polygon(b, [0, 0, d, d, 0], [0, f, f, 0, 0], k, m, l, p, q, n, !1, y);
            ...
            e.setCN(c, I, t + "left");
            e.setCN(c, z, t + "right");
            for (u = 0; u < d.length; u++) if (B = d[u]) a.push(B),
            e.setCN(c, B, t + "element");
    ...
    e.CategoryAxis = e.Class({
        ...
        draw: function() {
            ...
            if (e.ifArray(a)) {
                ...
                this.maxTime = e.resetDateToMin(new Date(this.lastTime + 1.05 * x), this.minPeriod, 1, p).getTime(),
                ...
                this.parseDatesDraw();
                    ...
                    if (this.cellWidth = this.getStepWidth(g), g < k && (k = g), h += this.start, this.stepWidth = this.getStepWidth(g), 0 < k) for (k = Math.floor(g / k), g = this.chooseMinorFrequency(k), n = h, n / 2 == Math.round(n / 2) && n--, 0 > n && (n = 0), a = 0, this.end - n + 1 >= this.autoRotateCount && (this.labelRotationR = this.autoRotateAngle), b = n; b <= this.end + 2; b++) {
                        ...
                        if (t && !isNaN(g)) if (b / g == Math.round(b / g) || q) b / k == Math.round(b / k) || q || (this.gridAlpha = this.minorGridAlpha, n = void 0);
                        else continue;
                    ...
                    a = n;
                    if (this.data[n].time != e.resetDateToMin(new Date(this.data[n].time), f, y, p).getTime()) for (p = 0, v = x, b = n; b < A; b++) g = this.data[b].time,
                    this.checkPeriodChange(f, y, g, v) && (p++, 2 <= p && (a = b, b = A), v = g);
                    ...
                    if (0 < this.gridCountR) for (b = n; b < A; b++) if (g = this.data[b].time, this.checkPeriodChange(f, y, g, x) && b >= a) {
                        ...
                        if (b == d && !m || b == k && !l) n = " ";
                        B ? B = !1 : (q || (x = !1), p - this.previousPos > this.safeDistance * Math.cos(this.labelRotationR * Math.PI / 180) && (this.labelFunction && (n = this.labelFunction(n, new Date(g), this, f, y, r)), this.boldLabels && (x = !0), r = new this.axisItemRenderer(this, p, n, void 0, void 0, void 0, void 0, x), t = r.graphics(), this.pushAxisItem(r), t = t.getBBox().width, e.isModern || (t -= p), this.previousPos = p + t));
                        r = x = g
                    }
                }
                for (b = 0; b < this.data.length; b++) if (v = this.data[b]) m = this.parseDates && !this.equalSpacing ? Math.round((v.time - this.startTime) * this.stepWidth + this.cellWidth / 2) : this.getCoordinate(b - h),
                isNaN(v.widthValue) || (v.percentWidthValue = v.widthValue / u * 100, m = this.rotate ? this.height * v.widthValue / u: this.width * v.widthValue / u),
                v.x[this.id] = m;
                m = this.guides.length;
                for (b = 0; b < m; b++) l = this.guides[b],
                q = k = k = t = d = NaN,
                u = l.above,
                l.toCategory && (k = c.getCategoryIndexByValue(l.toCategory), isNaN(k) || (d = this.getCoordinate(k - h), l.expand && (d += this.cellWidth / 2), r = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, l), this.pushAxisItem(r, u))),
                l.category && (q = c.getCategoryIndexByValue(l.category), isNaN(q) || (t = this.getCoordinate(q - h), l.expand && (t -= this.cellWidth / 2), k = (d - t) / 2, r = new this.axisItemRenderer(this, t, l.label, !0, NaN, k, l), this.pushAxisItem(r, u))),
                q = c.dataDateFormat,
                l.toDate && (l.toDate = e.getDate(l.toDate, q, this.minPeriod), this.equalSpacing ? (k = c.getClosestIndex(this.data, "time", l.toDate.getTime(), !1, 0, this.data.length - 1), isNaN(k) || (d = this.getCoordinate(k - h))) : d = (l.toDate.getTime() - this.startTime) * this.stepWidth, r = new this.axisItemRenderer(this, d, "", !0, NaN, NaN, l), this.pushAxisItem(r, u)),
                l.date && (l.date = e.getDate(l.date, q, this.minPeriod), this.equalSpacing ? (q = c.getClosestIndex(this.data, "time", l.date.getTime(), !1, 0, this.data.length - 1), isNaN(q) || (t = this.getCoordinate(q - h))) : t = (l.date.getTime() - this.startTime) * this.stepWidth, k = (d - t) / 2, q = !0, l.toDate && (q = !1), r = "H" == this.orientation ? new this.axisItemRenderer(this, t, l.label, q, 2 * k, NaN, l) : new this.axisItemRenderer(this, t, l.label, !1, NaN, k, l), this.pushAxisItem(r, u)),
                (0 < d || 0 < t) && (d < this.width || t < this.width) && (d = new this.guideFillRenderer(this, t, d, l), t = d.graphics(), this.pushAxisItem(d, u), l.graphics = t, t.index = b, l.balloonText && this.addEventListeners(t, l))
            }
            this.axisCreated = !0;
            c = this.x;
            h = this.y;
            ...
            this.labelsSet.show();
            this.positionTitle(); (c = this.axisLine.set) && c.toFront();
        ...
        xToIndex: function(a) {
            ...
            d = c.rotate,
            f = this.stepWidth;
            this.parseDates && !this.equalSpacing ? (a = this.startTime + Math.round(a / f) - this.minDuration() / 2, c = c.getClosestIndex(b, "time", a, !1, this.start, this.end + 1)) : (this.startOnAxis || (a -= f / 2), c = this.start + Math.round(a / f));
