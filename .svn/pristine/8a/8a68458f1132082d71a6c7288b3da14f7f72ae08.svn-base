(function() {
    ...
    d.maps = {},
    d.inheriting = {},
    d.charts = [], d.onReadyArray = [], d.useUTC = !1, d.updateRate = 30, d.uid = 0, d.lang = {},
    d.translations = {},
    d.mapTranslations = {},
    d.windows = {},
    d.initHandlers = []);
    ...
    d.update = function() {
        ...
        if (a) for (var c = 0; c < a.length; c++) a[c].update && a[c].update(),
        b && a[c].autoResize && a[c].validateSize && a[c].validateSize()
    };
    d.bezierX = 3;
    d.bezierY = 6
})(); (function() {
    ...
    d.AxisBase = d.Class({
        ...
        positionTitle: function() {
            ...
            if (a) {
                ...
                case "right":
                    b = e + g + 10 + n,
                    p && (b += 7),
                    c = ("left" == q ? l + 2 : "right" == q ? -2 : l / 2) + this.titleDY,
                    m = -90
                }
        ...
        parseDatesDraw: function() {
            ...
            if (g == v && 1 == w && this.centerLabelOnFullPeriod || this.autoWrap || this.centerLabels) n = z * this.stepWidth,
            ...
            if (0 < this.gridCountR) for (B - 5 - k > this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), a = k; a <= B; a++) {
                ...
                "MM" == v && (h = (q - l) / z, 1.5 <= (q - l) / z && (q = q - (h - 1) * z + d.getPeriodDuration("DD", 3), q = d.resetDateToMin(new Date(q), v, 1).getTime(), C += z));
                ...
                f = q + A * h,
                f = d.resetDateToMin(new Date(f), v, u, r).getTime(),
    ...
    d.ValueAxis = d.Class({
        ...
        draw: function() {
            ...
            if (isNaN(this.min) || isNaN(this.max) || !this.foundGraphs || Infinity == this.min || -Infinity == this.max) e = !0;
                ...
                this.exponential = !1;
                for (g = f; g < r; g += q) w = d.roundTo(this.step * g + this.min, u),
                ...
                this.parseDatesDraw();
                else for (r >= this.autoRotateCount && !isNaN(this.autoRotateAngle) && (this.labelRotationR = this.autoRotateAngle), g = f; g < r; g += q) if (c = u * g + this.minCalc, h && this.max - this.min > 10 * this.min && (c -= this.min), c = d.roundTo(c, this.maxDecCount + 1), !this.integersOnly || Math.round(c) == c) if (isNaN(x) || Number(d.toFixed(c, x)) == c) { ! 0 === h && (0 === c && (c = this.minReal), t > this.logGridLimit && (c = Math.pow(10, g)));
                    ...
                    A = new this.axisItemRenderer(this, f, A, void 0, J, void 0, void 0, this.boldLabels);
                    this.pushAxisItem(A);
                    ...
                    if (!isNaN(H) && 0 < w && g < r - 1) {
                        ...
                        for (A = 1; A < u / H; A++) v = this.getCoordinate(c + H * A),
                        v = new this.axisItemRenderer(this, v, "", !1, 0, 0, !1, !1, 0, !0),
                        this.pushAxisItem(v);
                        this.gridAlpha = f
                    }
                }
            ...
            t = this.labelsSet;
            this.positionTitle();
            "radar" != a.type ? (a = this.viX, H = this.viY, b.translate(a, H), t.translate(a, H)) : h.toFront(); ! this.visible || e ? (b.hide(), h.hide(), t.hide()) : (b.show(), h.show(), t.show());
        ...
        formatValue: function(a, b, c) {
            ...
            g = this.chart; ! 0 === this.logarithmic && (e = -1 != String(a).indexOf("e") ? !0 : !1);
            ...
            for (e = a; e <= b; e++) {
                ...
                for (f in d) if (d.hasOwnProperty(f)) {
                    ...
                    if (g.includeInMinMax && (!g.hidden || this.includeHidden)) {
                        ...
                        var k;
                        if (this.minMaxField) k = g[this.minMaxField],
                        k < c && (c = k);
            ...
            for (b = this.start; b <= this.end; b++) {
                ...
                for (e in c) if (c.hasOwnProperty(e)) {
                    ...
                    if (d.includeInMinMax && (!d.hidden || this.includeHidden)) {
                        ...
                        var f;
                        if (this.minMaxField) f = d[this.minMaxField],
                        f > a && (a = f);
        ...
        getCoordinate: function(a) {
            ...
            d = this.stepWidth,
            f = this.min,
            g = this.minReal; ! 0 === this.logarithmic ? (0 === a && (a = this.treatZeroAs), a = Math.log(a) * Math.LOG10E - Math.log(g) * Math.LOG10E, b = b ? !0 === c ? e - d * a: d * a: !0 === c ? d * a: e - d * a) : b = !0 === c ? b ? e - d * (a - f) : d * (a - f) : b ? d * (a - f) : e - d * (a - f);
    ...
    d.RecItem = d.Class({
        construct: function(a, b, c, e, h, f, g, k, l, m, n, p) {
            ...
            if ("H" == Ra) {
                if (0 <= b && b <= sa + 1 && (0 < B && 0 < z && b + l <= sa + 1 && (da = d.line(x, [b + l, b + l], [0, B], v, z, C), A.push(da)), 0 < D && (ta = d.line(x, [b, b + qa, b + qa], [V, V + ka, ka], L, D, C, H), A.push(ta))), y = 0, E = b, g && 90 == n && Q && (E -= t), !1 === e ? (fa = "start", y = "bottom" == ca ? Q ? y + B: y - B: Q ? y - B: y + B, E += 3, 0 < h && (E += h / 2 - 3, fa = "middle"), 0 < n && (fa = "middle")) : fa = "middle", 1 == ea && 0 < I && !g && !m && aa < sa && (e = d.fitToBounds(b, 0, sa), aa = d.fitToBounds(aa, 0, sa), X = e - aa, 0 < X && (ya = d.rect(x, X, a.height, J, I), ya.translate(e - X + qa, ka), A.push(ya))), "bottom" == ca ? (y += V + t / 2 + ba, Q ? (0 < n ? (y = V - ga / 2 * Math.sin(S) - B - 3, E += ga / 2 * Math.cos(S) - 4 + 2) : 0 > n ? (y = V + ga * Math.sin(S) - B - 3 + 2, E += -ga * Math.cos(S) - Ja * Math.sin(S) - 4) : y -= B + t + 3 + 3, y -= oa) : (0 < n ? (y = V + ga / 2 * Math.sin(S) + B + 3, E -= ga / 2 * Math.cos(S)) : 0 > n ? (y = V + B + 3 - ga / 2 * Math.sin(S) + 2, E += ga / 2 * Math.cos(S)) : y += B + w + 3 + 3, y += oa)) : (y += ka + t / 2 - ba, E += qa, Q ? (0 < n ? (y = ga / 2 * Math.sin(S) + B + 3, E -= ga / 2 * Math.cos(S)) : y += B + 3, y += oa) : (0 < n ? (y = -(ga / 2) * Math.sin(S) - B - 6, E += ga / 2 * Math.cos(S)) : y -= B + t + 3 + w + 3, y -= oa)), "bottom" == ca ? X = (Q ? V - B - 1 : V + w - 1) + ba: (la = qa, X = (Q ? ka: ka - B - w + 1) - ba), f && (E += f), f = E, 0 < n && (f += ga / 2 * Math.cos(S)), Z && (t = 0, Q && (t = ga / 2 * Math.cos(S)), f + t > sa + 2 || 0 > f)) Z.remove(),
                Z = null
            } else {
                ...
                y += t / 2;
                "right" == ca ? (E += qa + sa + ba, y += ka, Q ? (f || (y -= t / 2 + 3), E = E - (B + 4) - oa) : (E += B + 4 + w, y -= 2, E += oa)) : Q ? (E += B + 4 - ba, f || (y -= t / 2 + 3), g && (E += qa, y += ka), E += oa) : (E += -B - w - 4 - 2 - ba, y -= 2, E -= oa);
            ...
            da && (da.translate(la, X), d.setCN(q, da, a.bcn + "tick"), d.setCN(q, da, p, !0), g && d.setCN(q, da, "guide")); ! 1 === a.visible && (da && da.remove(), Z && (Z.remove(), Z = null));
            Z && (Z.attr({
                "text-anchor": fa
            }), Z.translate(E, y, NaN, !0), 0 !== n && Z.rotate( - n, a.chart.backgroundColor), a.allLabels.push(Z), this.label = Z, d.setCN(q, Z, a.bcn + "label"), d.setCN(q, Z, p, !0), g && d.setCN(q, Z, "guide"));
    ...
    d.AmChart = d.Class({
        ...
        initChart: function() {
            ...
            if (a = this.numberFormatter) isNaN(a.precision) || (this.precision = a.precision),
            void 0 !== a.thousandsSeparator && (this.thousandsSeparator = a.thousandsSeparator),
            void 0 !== a.decimalSeparator && (this.decimalSeparator = a.decimalSeparator); (a = this.percentFormatter) && !isNaN(a.precision) && (this.percentPrecision = a.precision);
            this.nf = {
    ...
    d.AmGraph = d.Class({
        ...
        createRadarGraph: function() {
            ...
            for (m = this.start; m <= this.end; m++) {
                ...
                if (isNaN(p)) this.connect || (this.drawLineGraph(b, c, e, d), b = [], c = [], e = [], d = []);
                    ...
                    n.x = p;
                    n.y = r;
                    if (x = this.labelText) n = this.createLabel(n, p, r, x),
                    this.positionLabel(p, r, n, t),
        ...
        positionLabel: function(a, b, c, e) {
            ...
            if (e) {
                ...
                c.translate(a, b);
                k = c.getBBox(); ! this.showAllValueLabels && r && f && (k.height > l.columnHeight || k.width > l.columnWidth) && (c.remove(), c = !1);
        ...
        createSerialGraph: function() {
            ...
            if (! (Q || "line" != g && "smoothedLine" != g && "step" != g || (1 == e.length && "step" != g && "none" == this.bullet && (this.bullet = "round", this.resetBullet = !0), !Ka && void 0 == Da || m))) {
                ...
                r ? (ga = p, Ja = Math.abs(Kb - Ga) + 1, rb = p, sb = Math.abs(gb - Ga) + 1, fb = qb = 0, f.reversed ? (Z = 0, eb = Ga) : (Z = Ga, eb = 0)) : (Ja = n, ga = Math.abs(Kb - Ga) + 1, sb = n, rb = Math.abs(gb - Ga) + 1, eb = Z = 0, f.reversed ? (fb = q, qb = Ga) : fb = Ga + 1)
            }
            var Ha = Math.round;
            this.pmx = Ha(Z);
            this.pmy = Ha(qb);
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g) {
                if (0 < W) {
                    ...
                    if (this.lineColorField) for (K = W; - 1 < K; K--) if (E = e[K], y = E.axes[f.id].graphs[b], y.lineColor) {
            ...
            for (K = W; K <= ea; K++) {
                ...
                if (Ca) {
                    ...
                    if ("candlestick" == g || "ohlc" == g) Y = Ca.close,
                    yb = Ca.low,
                    Ea = f.getCoordinate(yb),
                    xb = Ca.high,
                    Fa = f.getCoordinate(xb);
                    na = Ca.open;
                    F = f.getCoordinate(Y);
                    ...
                    if (!zb && Y < na || zb && Y < ta) y.isNegative = !0,
                    Ka && (Ia = Ka),
                    Xa && (Ta = Xa),
                    void 0 != Da && (Ba = Da);
                    Ya = !1;
                    ...
                    case "line":
                        if (isNaN(Y)) x || (this.drawLineGraph(A, w, T, U), A = [], w = [], T = [], U = []);
                            ...
                            if (Math.abs(G - hb) >= jb || Math.abs(F - ib) >= jb) A.push(G),
                            w.push(F),
                            hb = G,
                            ib = F;
                            ua = G;
                            va = F;
                            ia = G;
                            ja = F; ! La || isNaN(N) || isNaN(O) || (T.push(O), U.push(N));
                            if (Ya || void 0 != y.lineColor || void 0 != y.fillColors || !isNaN(y.dashLength)) this.drawLineGraph(A, w, T, U),
                            A = [G],
                            w = [F],
                            T = [],
                            U = [],
                            !La || isNaN(N) || isNaN(O) || (T.push(O), U.push(N)),
                            m ? Ma ? (this.lineColorSwitched = sa, this.fillColorsSwitched = tb) : (this.lineColorSwitched = Da, this.fillColorsSwitched = Ka) : (this.lineColorSwitched = y.lineColor, this.fillColorsSwitched = y.fillColors),
                            this.dashLengthSwitched = y.dashLength;
                    ...
                    case "column":
                        ...
                        if (!isNaN(Y)) {
                            ...
                            if (pa && (za = pa.set, d.setCN(a, pa.set, "graph-" + this.type), d.setCN(a, pa.set, "graph-" + this.id), y.className && d.setCN(a, pa.set, y.className, !0), y.columnGraphics = za, za.translate(R, P), this.columnsSet.push(za), (y.url || this.showHandOnHover) && za.setAttr("cursor", "pointer"), !Q)) {
                        ...
                        if (!isNaN(na) && !isNaN(Y)) {
                            ...
                            if (r) {
                                if (P = F - k / 2, R = O, M = k, P + M > p && (M = p - P), 0 > P && (M += P, P = 0), P < p && 0 < M) {
                                    var Bb, Cb;
                                    Y > na ? (Bb = [G, Pa], Cb = [O, Oa]) : (Bb = [O, Pa], Cb = [G, Oa]); ! isNaN(Pa) && !isNaN(Oa) && F < p && 0 < F && (Va = d.line(h, Bb, [F, F], wa, V, aa), ab = d.line(h, Cb, [F, F], wa, V, aa));
                                    ha = G - O;
                                ...
                                Db,
                                Eb;
                                Y > na ? (Db = [F, Fa], Eb = [N, Ea]) : (Db = [N, Fa], Eb = [F, Ea]); ! isNaN(Fa) && !isNaN(Ea) && G < n && 0 < G && (Va = d.line(h, [G, G], Db, wa, V, aa), ab = d.line(h, [G, G], Eb, wa, V, aa), d.setCN(a, Va, this.bcn + "line-high"), y.className && d.setCN(a, Va, y.className, !0), d.setCN(a, ab, this.bcn + "line-low"), y.className && d.setCN(a, ab, y.className, !0))
                            }
                    ...
                    if (!Q && !isNaN(Y)) {
                        ...
                        if (this.end - this.start <= Tb || 0 === Tb) {
                            ...
                            Vb = this.labelText;
                            if (Vb && Ub) {
                                var Jb = this.createLabel(y, ia, ja, Vb); (Jb = this.positionLabel(ua, va, Jb, Ub, M, ha)) && this.allBullets.push(Jb)
                            }
                            if ("regular" == I || "100%" == I) {
                                var Wb = f.totalText;
                                if (Wb) {
            ...
            if ("line" == g || "step" == g || "smoothedLine" == g)"smoothedLine" == g ? this.drawSmoothedGraph(A, w, T, U) : this.drawLineGraph(A, w, T, U),
        ...
        drawLineGraph: function(a, b, c, e) {
            ...
            if (1 < a.length) {
                ...
                u && (t = u);
                var x = h.dashLength; (u = h.dashLengthSwitched) && (x = u);
                ...
                void 0 === u || h.useNegativeColorIfDown || (p = d.line(k, a, b, u, r, p, x, !1, !0), d.setCN(g, p, h.bcn + "stroke"), d.setCN(g, p, h.bcn + "stroke-negative"), m.push(p));
                if (0 < f || 0 < w) if (p = a.join(";").split(";"), r = b.join(";").split(";"), n = g.type, "serial" == n || "radar" == n ? 0 < c.length ? (c.reverse(), e.reverse(), p = a.concat(c), r = b.concat(e)) : "radar" == n ? (r.push(0), p.push(0)) : h.rotate ? (r.push(r[r.length - 1]), p.push(v), r.push(r[0]), p.push(v), r.push(r[0]), p.push(p[0])) : (p.push(p[p.length - 1]), r.push(v), p.push(p[0]), r.push(v), p.push(a[0]), r.push(r[0])) : "xy" == n && (b = h.fillToAxis) && (d.isString(b) && (b = g.getValueAxisById(b)), "H" == b.orientation ? (v = "top" == b.position ? 0 : b.viH, p.push(p[p.length - 1]), r.push(v), p.push(p[0]), r.push(v), p.push(a[0]), r.push(r[0])) : (v = "left" == b.position ? 0 : b.viW, r.push(r[r.length - 1]), p.push(v), r.push(r[0]), p.push(v), r.push(r[0]), p.push(p[0]))), a = h.gradientRotation, 0 < f && (b = d.polygon(k, p, r, t, f, 1, "#000", 0, a), b.pattern(h.pattern, NaN, g.path), d.setCN(g, b, h.bcn + "fill"), l.push(b)), A || void 0 !== u) isNaN(w) && (w = f),
                A || (A = u),
                k = d.polygon(k, p, r, A, w, 1, "#000", 0, a),
                d.setCN(g, k, h.bcn + "fill"),
                d.setCN(g, k, h.bcn + "fill-negative"),
                k.pattern(h.pattern, NaN, g.path),
                m.push(k),
                m.click(function(a) {
                    h.handleGraphEvent(a, "clickGraph")
                }).mouseover(function(a) {
        ...
        drawSmoothedGraph: function(a, b, c, e) {
            if (1 < a.length) {
                ...
                w && (q = w); (w = this.fillColorsSwitched) && (r = w);
        ...
        handleRollOver: function(a, b) {
            if (a) {
                ...
                e = this.showBalloon; ! c.chartCursor || "serial" != c.type && "gantt" != c.type || (e = !1, !c.chartCursor.valueBalloonsEnabled && this.showBalloon && (e = !0));
                if (e) {
    ...
    d.ChartCursor = d.Class({
        ...
        draw: function() {
            ...
            this.prevTX = [];
            this.prevTY = [];
            if (this.valueBalloonsEnabled) for (b = 0; b < a.graphs.length; b++) c = new d.AmBalloon,
            c.className = a.graphs[b].id,
            c.chart = a,
            d.copyProperties(a.balloon, c),
            a.graphs[b].valueBalloon = c;
        ...
        createCursor: function() {
            ...
            this.line = h;
            h.node.style.pointerEvents = "none"; (f = this.fullRectSet) ? (f.push(h), f.translate(this.x, this.y)) : this.set.push(h);
            ...
            this.setBalloonBounds(e, c, n); (a = this.vaBalloon) && this.setBalloonBounds(a, this.valueLineAxis, !n);
            this.hideCursor()
        },
        ...
        setPosition: function(a, b, c, e) {
            ...
            if ("cursor" == this.type) {
                ...
                (a != this.previousMousePosition || !0 === this.zoomed || this.oneBalloonOnly) && !isNaN(a) && ("mouse" == this.cursorPosition && (this.tempPosition = a), isNaN(c) && (c = this.chart.categoryAxis.xToIndex(a)), c != this.previousIndex || this.zoomed || "mouse" == this.cursorPosition || this.oneBalloonOnly) && (this.updateCursor(c, b, e), this.zoomed = !1),
            ...
            if (this.enabled) {
                ...
                if (t) {
                    ...
                    if (e.mouseIsOver || C || L || this.forceShow) if (this.forceShow = !1, L) {
                        ...
                        C && (h && z.hide(), A ? this.updateSelectionSize(NaN, x) : this.updateSelectionSize(x, NaN));
                        B = !0;
                        C && (B = !1);
                        this.categoryBalloonEnabled && B ? (this.setBalloonPosition(v, k, x, A), (z = this.categoryBalloonFunction) ? v.showBalloon(z(t.category)) : (z = x = "", k.parseDates ? (x = d.formatDate(t.category, this.categoryBalloonDateFormat, e), k = d.changeDate(new Date(t.category), e.categoryAxis.minPeriod, 1), z = d.formatDate(k, this.categoryBalloonDateFormat, e), -1 != x.indexOf("fff") && (x = d.formatMilliseconds(x, t.category), z = d.formatMilliseconds(z, k))) : (x = d.fixNewLines(t.category), u && (z = d.fixNewLines(u.category))), k = this.categoryBalloonText.replace(/\[\[category\]\]/g, String(x)), k = k.replace(/\[\[toCategory\]\]/g, String(z)), v.showBalloon(k))) : v.hide();
                        H && this.bulletsEnabled && this.showBullets();
                        if (this.oneBalloonOnly) {
                            x = Infinity;
                            for (k = 0; k < H.length; k++) v = H[k],
                            v.showBalloon && !v.hidden && v.balloonText && (u = t.axes[v.valueAxis.id].graphs[v.id], z = u.y, "top" == v.showBalloonAt && (z = 0), "bottom" == v.showBalloonAt && (z = this.height), isNaN(z) || (A ? Math.abs(f - z) < x && (x = Math.abs(f - z), J = v) : Math.abs(g - z) < x && (x = Math.abs(g - z), J = v)));
                        ...
                        if (!c && (a != this.previousIndex || J != this.previousMostCloseGraph) && (this.normalizeBulletSize(), this.destroyValueBalloons(), this.resizedBullets = [], H && this.valueBalloonsEnabled && B && e.balloon.enabled)) {
                            ...
                            for (k = 0; k < H.length; k++) if (v = H[k], z = NaN, (!this.oneBalloonOnly || v == J) && v.showBalloon && !v.hidden && v.balloonText && ("step" == v.type && "left" == v.stepDirection && (t = this.data[a + 1]), t)) {
                                ...
                                "bottom" == v.showBalloonAt && (z = this.height);
            ...
            if (a) {
                ...
                if (this.enabled && 0 < b.length) {
                    if (this.pan) this.rolledOver = !1;
                        ...
                        c.target = this;
                        c.chart = a;
                        if ("cursor" == this.type) this.rotate ? this.selectionPosY = h: this.selectionPosX = h = e,
        ...
        handleMouseDown: function(a) {
            if (this.zoomable || this.pan || this.drawing) {
                ...
                e = c.mouseX - this.x,
                h = c.mouseY - this.y;
                if (0 < e && e < this.width && 0 < h && h < this.height || "fake" == a) this.setPosition(),
                this.selectWithoutZooming && d.remove(this.selection),
                this.drawing ? (this.drawStartY = h, this.drawStartX = e, this.drawingNow = !0) : this.pan ? (this.zoomable = !1, c.setMouseCursor("move"), this.panning = !0, this.panClickPos = b ? h: e, this.panClickStart = this.start, this.panClickEnd = this.end, this.panClickStartTime = this.startTime, this.panClickEndTime = this.endTime) : this.zoomable && ("cursor" == this.type ? (this.fromIndex = this.index, b ? (this.initialMouse = h, this.selectionPosY = this.linePos) : (this.initialMouse = e, this.selectionPosX = this.linePos)) : (this.initialMouseX = e, this.initialMouseY = h, this.selectionPosX = e, this.selectionPosY = h), this.zooming = !0)
            }
        }
    })
})(); (function() {
        ...
        dispatchScrollbarEvent: function() {
            if (this.skipEvent) this.skipEvent = !1;
                ...
                if (k.parseDates && !k.equalSpacing) {
                    if (a = g.lastTime, g = g.firstTime, k = Math.round(b / l) + g, b = this.dragging ? k + this.timeDifference: Math.round((b + c) / l) + g, k > b && (k = b), 0 < d && b - k < d && (b = Math.round(k + (b - k) / 2), e = Math.round(d / 2), k = b - e, b += e, e = !0), b > a && (b = a), b - d < k && (k = b - d), k < g && (k = g), k + d > b && (b = k + d), k != this.startTime || b != this.endTime) this.startTime = k,
                    this.endTime = b,
                    f.start = k,
                    f.end = b,
                    ...
                    this.fire(f.type, f)
                } else if (k.startOnAxis || (b += l / 2), c -= this.stepWidth / 2, d = k.xToIndex(b), b = k.xToIndex(b + c), d != this.start || this.end != b) k.startOnAxis && (this.resizingRight && d == b && b++, this.resizingLeft && d == b && (0 < d ? d--:b = 1)),
                this.start = d,
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    J = this.bulletSize,
                    I;
                    0 < w || 0 === x ? (0 < u && (a = d.rect(h, C, v, p, 0, t + 1, H, u, this.cornerRadius), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), p = d.rect(h, C, v, p, this.fillAlpha, t, q, this.borderAlpha, this.cornerRadius), this.showBullet && (I = d.circle(h, J, r, this.fillAlpha), f.push(I))) : (r = [], w = [], "H" != A ? (g = a - D, g > C - x && (g = C - x), g < x && (g = x), r = [0, g - x, a - D, g + x, C, C, 0, 0], w = L ? [0, 0, b - z, 0, 0, v, v, 0] : [v, v, b - z, v, v, 0, 0, v]) : (r = b - z, r > v - x && (r = v - x), r < x && (r = x), w = [0, r - x, b - z, r + x, v, v, 0, 0], r = a < g + (l - g) / 2 ? [0, 0, D < a ? 0 : a - D, 0, 0, C, C, 0] : [C, C, D + C > a ? C: a - D, C, C, 0, 0, C]), 0 < u && (a = d.polygon(h, r, w, p, 0, t, H, u), a.translate(1, 1), f.push(a)), p = d.polygon(h, r, w, p, this.fillAlpha, t, q, this.borderAlpha));
                    this.bg = p;
                    f.push(p);
                    p.toFront();
    ...
    d.AmCoordinateChart = d.Class({
        ...
        parseSerialData: function(a) {
            ...
            if (a) {
                ...
                var p, q, r = {},
                t;
                f && (c = d.extractPeriod(k.minPeriod), p = c.period, q = c.count, t = d.getPeriodDuration(p, q));
                var u = {};
                this.lookupTable = u;
                    ...
                    for (D = 0; D < B.length; D++) {
                        ...
                        for (L = 0; L < b.length; L++) {
                            ...
                            if (c.valueAxis.id == C) {
                                ...
                                var ea = z;
                                c.dataProvider && (ea = e);
                                W.values = this.processValues(ea, c, I); ! c.connect && w && w[H] && 0 < J && v.time - r[H] >= t * J && (w[H].gap = !0);
            ...
            c.dataProvider && this.parseGraphData(c)
        },
    ...
    d.AmSlicedChart = d.Class({
        ...
        pullSlice: function(a, b, c) {
            var e = this.pullOutDuration; ! 0 === c && (e = 0);
        ...
        parseData: function() {
            ...
            if (void 0 !== b) {
                ...
                for (h = 0; h < c; h++) {
                    ...
                    var k = b[h];
                    f.dataContext = k;
                    null !== k[this.valueField] && (f.value = Number(k[this.valueField])); (g = k[this.titleField]) || (g = "");
                    f.title = g;
                    f.pulled = d.toBoolean(k[this.pulledField], !1); (g = k[this.descriptionField]) || (g = "");
                    f.description = g;
                    f.labelRadius = Number(k[this.labelRadiusField]);
                    f.switchable = !0;
                    f.className = k[this.classNameField];
                    f.url = k[this.urlField];
                    g = k[this.patternField]; ! g && this.patterns && (g = this.patterns[h]);
                    f.pattern = g;
                ...
                for (h = b = 0; h < c; h++) f = a[h],
                f.percents = f.value / e * 100,
                ...
                for (h = 0; h < a.length; h++) c ? g = d.adjustLuminosity(c, h * e / 100) : (g = this.colors[h], void 0 === g && (g = d.randomColor())),
                void 0 === a[h].color && (a[h].color = g);
                this.recalculatePercents()
            }
        },
        recalculatePercents: function() {
            ...
            for (c = 0; c < a.length; c++) e = this.chartData[c],
        ...
        animateAgain: function() {
            ...
            for (var b = 0; b < a.chartData.length; b++) {
                ...
                c.started = !1;
                var e = c.wedge;
                e && e.translate(c.startX, c.startY); (e = c.labelSet) && e.translate(c.startX, c.startY)
            }
            b = a.startDuration;
    ...
    d.AmRectangularChart = d.Class({
        ...
        resetMargins: function() {
            ...
            if ("xy" == this.type) {
                ...
                e = this.valueAxes;
                for (b = 0; b < e.length; b++) c = e[b],
                c.ignoreAxisWidth || (c.setOrientation(this.rotate), c.fixAxisPosition(), a[c.position] = !0); (b = this.categoryAxis) && !b.ignoreAxisWidth && (b.setOrientation(!this.rotate), b.fixAxisPosition(), b.fixAxisPosition(), a[b.position] = !0)
            }
        ...
        measureMargins: function() {
            ...
            b = this.getAxisBounds(a[m], g, l, k, b),
            g = Math.round(b.l),
            l = Math.round(b.r),
            k = Math.round(b.t),
            b = Math.round(b.b);
            if (a = this.categoryAxis) b = this.getAxisBounds(a, g, l, k, b),
            g = Math.round(b.l),
            l = Math.round(b.r),
            k = Math.round(b.t),
            b = Math.round(b.b);
    ...
    d.bullet = function(a, b, c, e, h, f, g, k, l, m, n, p) {
        ...
        case "xError":
            q = a.set(),
            q.push(d.line(a, [ - c / 2, c / 2], [0, 0], e, h, f)),
            q.push(d.line(a, [ - c / 2, -c / 2], [ - l, l], e, h, f)),
            q.push(d.line(a, [c / 2, c / 2], [ - l, l], e, h, f))
        }
        q && q.pattern(n, NaN, p);
        return q
    ...
    d.wedge = function(a, b, c, e, h, f, g, k, l, m, n, p, q) {
        ...
        e = a.set();
        var J;
        u && (x = r(10 * x), v = r(10 * v), B = r(10 * B), C = r(10 * C), w = r(10 * w), z = r(10 * z), D = r(10 * D), A = r(10 * A), b = r(10 * b), l = r(10 * l), c = r(10 * c), f *= 10, g *= 10, k *= 10, t *= 10, 1 > Math.abs(h) && 1 >= Math.abs(B - v) && 1 >= Math.abs(D - z) && (J = !0));
        h = "";
        var I;
        ...
        u ? (J || (h = " A" + r(b - f) + "," + r(c - g) + "," + r(b + f) + "," + r(c + g) + "," + r(v) + "," + r(z) + "," + r(B) + "," + r(D)), f = " M" + r(x) + "," + r(w) + " L" + r(v) + "," + r(z) + h + " L" + r(C) + "," + r(A)) : f = " M" + x + "," + w + " L" + v + "," + z + (" A" + f + "," + g + ",0," + H + ",1," + B + "," + D) + " L" + C + "," + A;
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (v = 0; v < A.length; v++) {
                ...
                L.translate(H, D);
                z++; ! isNaN(l) && z >= l && (z = 0, r++, D = D + C + m, B = f, C = 0);
                x.push(L)
            }
            w = x.getBBox();
            l = w.height + 2 * m - 1;
            ...
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    p = m / 3;
                        ...
                        if (g = this.createMarker("rectangle", n, a.fillAlphas, a.lineThickness, e, a.lineAlpha, r, g)) q = m,
                        g.translate(q, m / 2);
                        n = m
                    }
                    d.setCN(b, g, "graph-" + c);
                    ...
                    var t;
                    isNaN(this.gradientRotation) || (t = 180 + this.gradientRotation); (g = this.createMarker(c, e, h, void 0, void 0, void 0, t, g)) && g.translate(m / 2, m / 2)
                }
                ...
                d.setCN(b, l, a.className, !0); (f = this.switchType) && "none" != f && 0 < m && ("x" == f ? (r = this.createX(), r.translate(m / 2, m / 2)) : r = this.createV(), r.dItem = a, !0 !== a.hidden ? "x" == f ? r.hide() : r.show() : "x" != f && r.hide(), this.switchable || r.hide(), this.addListeners(r, a), a.legendSwitch = r, l.push(r), d.setCN(b, r, "legend-switch"));
                f = this.color;
                ...
                var u;
                e && (e = d.fixBrakes(e), a.legendTextReal = e, u = this.labelWidth, u = isNaN(u) ? d.text(this.container, e, f, b.fontFamily, r, "start") : d.wrappedText(this.container, e, f, b.fontFamily, r, "start", !1, u, 0), d.setCN(b, u, "legend-label"), u.translate(this.lx + n, this.ly), l.push(u), b = u.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
