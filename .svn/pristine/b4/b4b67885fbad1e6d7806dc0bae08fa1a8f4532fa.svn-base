...
SWFUpload.prototype.loadFlash = function () {
	...
	targetElement = typeof this.settings.button_placeholder_id=="object"?this.settings.button_placeholder_id:(document.getElementById(this.settings.button_placeholder_id) || this.settings.button_placeholder);
