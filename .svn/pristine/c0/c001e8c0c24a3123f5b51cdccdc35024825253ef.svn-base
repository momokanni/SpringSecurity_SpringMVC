...
public class Des {  
    /** 加密、解密key. */  
    private static final String PASSWORD_CRYPT_KEY = "xkoalqqif185kgycke";
    /** 加密算法,可用 DES,DESede,Blowfish. */  
    private final static String ALGORITHM = "DES";  
    public static void main(String[] args) throws Exception {  
    	String phone = "13241874822";
    	String pwd = "gundam";
    	String code = "567489";
        String md5Password = String.format("{ \"phone\" : \"%s\", \"passwd\" : \"%s\", \"identify\": \"%s\" }", phone, pwd, code);
     ...
     * Creation date: 2007-7-31 - 下午12:06:24 
     */  
    public final static int decryptInt(String data) throws Exception {  
        String result =  new String(decrypt(hex2byte(data.getBytes()),  
                PASSWORD_CRYPT_KEY.getBytes()));  
        if ( ValidateUtil.isNumber( result ) ){
