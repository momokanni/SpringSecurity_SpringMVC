...
(function ($) {
    ...
    function Scroller(elem, settings) {
        ...
        function read() {
            ...
            that.temp = eval('['+elm.attr("val")+']');//((input && that.val !== null && that.val != elm.val()) || that.values === null) ? s.parseValue(elm.val() || '', that) : that.values.slice(0);          
        	//that.temp = [1,1];
        	that.setValue(true);
        }
        ...
        */
        that.show = function (prevAnim) {
            ...
            var html = "";
            if(s.column == 1){
            	html += '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr"><div class="autotit p_02 ft16 dn"><span class="fl wd100">'+s.title[0]+'</span></div> ');
            }else{
            	html += '<div class="dw-trans ' + s.theme + ' dw-' + s.display + '">' + (s.display == 'inline' ? '<div class="dw dwbg dwi"><div class="dwwr">' : '<div class="dw-persp">' + '<div class="dwo"></div><div class="dw dwbg' + mAnim + '"><div class="dw-arrw"><div class="dw-arrw-i"><div class="dw-arr"></div></div></div><div class="dwwr"><div class="autotit p_02 ft16 dn"><span class="fl wd50">'+s.title[0]+'</span><span class="fr wd50">'+s.title[1]+'</span></div> ');
            }
            for (i = 0; i < s.wheels.length; i++) {
            	...
            	for (label in s.wheels[i]) {
            		...
            		html += '<td><div class="dwwl dwrc dwwl' + l + '">' + (s.mode != 'scroller' ? '<div class="dwwb dwwbp" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>+</span></div><div class="dwwb dwwbm" style="height:' + hi + 'px;line-height:' + hi + 'px;"><span>&ndash;</span></div>' : '') + '<div class="dwl dn">' + label + '</div><div class="dww" style="height:' + (s.rows * hi) + 'px;"><div class="dw-ul">';
            		// Create wheel values
            		html += generateWheelItems(l);
            		html += '</div><div class="dwwo"></div></div><div class="dwwol"></div></div></td>';
            		if(l ==0){
            			//html +='<td class="ft16 cl11"></td>';
            		}
            		l++;
            	}
            	html += '</tr></table></div></div>';
            }
            html += (s.display != 'inline' ? '<div class="dwbc' + (s.button3 ? ' dwbc-p' : '') + '"><span class="dwbw dwb-s"><span class="dwb">' + s.cancelText + '</span></span>' + (s.button3 ? '<span class="dwbw dwb-n" style="display:none;"><span class="dwb">' + s.button3Text + '</span></span>' : '') + '<span class="dwbw dwb-c"><span class="dwb">' + s.setText + '</span></span></div></div>' : '<div class="dwcc"></div>') + '</div></div></div>';
            dw = $(html);
