(function() {
    ...
    d.AmChart = d.Class({
        ...
        measure: function() {
            ...
            if (a) {
                ...
                f = Math.round(d.toCoordinate(this.height, e)); (c != this.previousWidth || e != this.previousHeight) && 0 < a && 0 < f && (b.style.width = a + "px", b.style.height = f + "px", b.style.padding = 0, g && g.setSize(a, f), this.balloon = d.processObject(this.balloon, d.AmBalloon, this.theme), this.balloon.setBounds(2, 2, a - 2, f));
                this.balloon.chart = this;
                this.realWidth = a;
                this.realHeight = f;
                this.divRealWidth = c;
        ...
        draw: function() {
            ...
            if (!isNaN(a)) {
                ...
                if (this.show) {
                    ...
                    G = this.bulletSize,
                    B;
                    0 < A || 0 === z ? (0 < y && (a = d.rect(g, v, w, r, 0, q + 1, E, y, this.cornerRadius), d.isModern ? a.translate(1, 1) : a.translate(4, 4), f.push(a)), r = d.rect(g, v, w, r, this.fillAlpha, q, t, this.borderAlpha, this.cornerRadius), this.showBullet && (B = d.circle(g, G, p, this.fillAlpha), f.push(B))) : (p = [], A = [], "H" != C ? (h = a - u, h > v - z && (h = v - z), h < z && (h = z), p = [0, h - z, a - u, h + z, v, v, 0, 0], A = F ? [0, 0, b - x, 0, 0, w, w, 0] : [w, w, b - x, w, w, 0, 0, w]) : (p = b - x, p > w - z && (p = w - z), p < z && (p = z), A = [0, p - z, b - x, p + z, w, w, 0, 0], p = a < h + (l - h) / 2 ? [0, 0, u < a ? 0 : a - u, 0, 0, v, v, 0] : [v, v, u + v > a ? v: a - u, v, v, 0, 0, v]), 0 < y && (a = d.polygon(g, p, A, r, 0, q, E, y), a.translate(1, 1), f.push(a)), r = d.polygon(g, p, A, r, this.fillAlpha, q, t, this.borderAlpha));
                    this.bg = r;
                    f.push(r);
                    r.toFront();
    ...
    d.bullet = function(a, b, c, e, g, f, h, k, l, m, n, r) {
        ...
        case "square":
            ...
            break;
        case "rectangle":
            t = d.polygon(a, [ - c, c, c, -c], [c / 2, c / 2, -c / 2, -c / 2], e, g, f, h, k, m - 180);
            break;
        case "diamond":
    ...
    d.wedge = function(a, b, c, e, g, f, h, k, l, m, n, r, t) {
        ...
        e = a.set();
        var G;
        y && (z = p(10 * z), w = p(10 * w), D = p(10 * D), v = p(10 * v), A = p(10 * A), x = p(10 * x), u = p(10 * u), C = p(10 * C), b = p(10 * b), l = p(10 * l), c = p(10 * c), f *= 10, h *= 10, k *= 10, q *= 10, 1 > Math.abs(g) && 1 >= Math.abs(D - w) && 1 >= Math.abs(u - x) && (G = !0));
        g = "";
        var B;
        ...
        y ? (G || (g = " A" + p(b - f) + "," + p(c - h) + "," + p(b + f) + "," + p(c + h) + "," + p(w) + "," + p(x) + "," + p(D) + "," + p(u)), f = " M" + p(z) + "," + p(A) + " L" + p(w) + "," + p(x) + g + " L" + p(v) + "," + p(C)) : f = " M" + z + "," + A + " L" + w + "," + x + (" A" + f + "," + h + ",0," + E + ",1," + D + "," + u) + " L" + v + "," + C;
    ...
    d.AmLegend = d.Class({
        ...
        arrangeEntries: function() {
            ...
            for (w = 0; w < C.length; w++) {
                ...
                F.translate(E, u);
                x++; ! isNaN(l) && x >= l && (x = 0, p++, u = u + v + m, D = f, v = 0);
                z.push(F)
            }
            A = z.getBBox();
            l = A.height + 2 * m - 1;
            ...
            c.toBack();
            b = f;
            if ("top" == a || "bottom" == a || "absolute" == a || "outside" == a)"center" == this.align ? b = f + (n - A.width) / 2 : "right" == this.align && (b = f + n - A.width);
            z.translate(b, m + 1);
        ...
        createEntry: function(a) {
            if (!1 !== a.visibleInLegend) {
                ...
                if (this.useGraphSettings) {
                    ...
                    if ("line" == c || "step" == c || "smoothedLine" == c || "ohlc" == c) h = l.set(),
                    ...
                    h.push(n),
                    a.bullet && (a.hidden || (e = a.bulletColorR), n = d.bullet(l, a.bullet, a.bulletSize, e, a.bulletAlpha, a.bulletBorderThickness, f, a.bulletBorderAlpha)) && (d.setCN(b, n, "graph-bullet"), n.translate(m + 1, m / 2), h.push(n)),
                    t = 0,
                    n = m,
                    r = m / 3;
                    else {
                        ...
                        if (h = this.createMarker("rectangle", n, a.fillAlphas, a.lineThickness, e, a.lineAlpha, p, h)) t = m,
                        h.translate(t, m / 2);
                        n = m
                    }
                    d.setCN(b, h, "graph-" + c);
                    ...
                    var q;
                    isNaN(this.gradientRotation) || (q = 180 + this.gradientRotation); (h = this.createMarker(c, e, g, void 0, void 0, void 0, q, h)) && h.translate(m / 2, m / 2)
                }
                ...
                d.setCN(b, l, a.className, !0); (f = this.switchType) && "none" != f && 0 < m && ("x" == f ? (p = this.createX(), p.translate(m / 2, m / 2)) : p = this.createV(), p.dItem = a, !0 !== a.hidden ? "x" == f ? p.hide() : p.show() : "x" != f && p.hide(), this.switchable || p.hide(), this.addListeners(p, a), a.legendSwitch = p, l.push(p), d.setCN(b, p, "legend-switch"));
                f = this.color;
                ...
                var y;
                e && (e = d.fixBrakes(e), a.legendTextReal = e, y = this.labelWidth, y = isNaN(y) ? d.text(this.container, e, f, b.fontFamily, p, "start") : d.wrappedText(this.container, e, f, b.fontFamily, p, "start", !1, y, 0), d.setCN(b, y, "legend-label"), y.translate(this.lx + n, this.ly), l.push(y), b = y.getBBox().width, this.maxLabelWidth < b && (this.maxLabelWidth = b));
        ...
        createMarker: function(a, b, c, e, g, f, h, k) {
    ...
    d.AmMap = d.Class({
        ...
        initChart: function() {
            ...
            this.drawChart()) : (this.chartDiv.style.textAlign = "", this.chartDiv.setAttribute("class", "ammapAlert"), this.chartDiv.innerHTML = this.svgNotSupported, this.fire("failed", {
                type: "failed",
                chart: this
            }))
        },
        ...
        rescaleMapAndObjects: function() {
            ...
            if (this.areasSettings.adjustOutlineThickness) {
                ...
                d = 0; d < b.length; d++)(c = b[d]) && c.setAttr("stroke-width", this.areasSettings.outlineThickness / a);
                ...
                if (a = b.mapContainer) {
                    ...
                    if (!isNaN(k)) {
                        ...
                        if (!isNaN(q)) {
                            ...
                            l = (b.zoomY() - l * p) * (k / h) + l * p;.1 < Math.abs(k - h) && (b.zoomTo(k, q, l, !0), b.mapWasPinched = !0, clearTimeout(b.pinchTO))
                        }
                    }
                    k = a.scale;
            ...
            if (e) {
                if (d.setCN(c, e, "selected-object"), a.bringForwardOnHover && e.toFront(), !a.preserveOriginalAttributes) {
                    ...
                    if ("MapLine" == a.objectType) {
                        ...
                        if (l = a.arrowSvg) l.setAttr("fill", f),
                        l.setAttr("stroke", f)
                    }
                    if (l = a.imageLabel) {
        ...
        returnInitialColorReal: function(a) {
            ...
            if (b) {
                ...
                if ("MapLine" == a.objectType) {
                    ...
                    if (e = a.arrowSvg) e.setAttr("fill", c),
                    e.setAttr("stroke", c)
                }
                var e = a.alphaReal,
        ...
        processObjects: function() {
            ...
            if (0 < a.images.length || 0 < a.areas.length || 0 < a.lines.length || a == this.dataProvider) {
                ...
                e && e.remove();
                this.stageLinesContainer = e = b.set();
            ...
            if (c) {
                ...
                for (g = 0; g < k; g++) {
                    ...
                    if (0 !== f.childNodes.length || "" !== m || !1 !== n) if (3 == f.nodeType || 4 == f.nodeType) {
                        ...
                        var r;
                        void 0 !== a[b][l] ? void 0 === a[b][l].length ? (r = a[b][l], a[b][l] = [], a[b][l].push(r), a[b][l].push({}), r = a[b][l][1]) : "object" == typeof a[b][l] && (a[b][l].push({}), r = a[b][l][a[b][l].length - 1]) : (a[b][l] = {},
                        r = a[b][l]);
    ...
    d.ZoomControl = d.Class({
        ...
        init: function(a, b) {
            ...
            if (f) {
                ...
                F.push(I);
                for (B = 1; B < G; B++) v = g + B * f,
                v = d.line(b, [1, E - 2], [v, v], c.gridColor, c.gridAlpha, 1),
                d.setCN(a, v, "zoom-grid"),
                I.push(v);
        ...
        update: function() {
            ...
            f = this.buttonSize,
            h = this.chart;
            h && (this.isDragging ? (h.stopDrag(), a = g.y + (h.mouseY - this.previousY), a = d.fitToBounds(a, f, this.realGridHeight + f), c = 100 * Math.pow(b, e - (a - f) / c), h.zoomTo(c, NaN, NaN, !0)) : (a = Math.log(h.zoomLevel() / 100) / Math.log(b), a = (e - a) * c + f), this.previousY = h.mouseY, this.previousDY != a && g && (g.translate((this.buttonSize - this.draggerSize) / 2, a), this.previousDY = a))
        }
    })
})(); (function() {
    var d = window.AmCharts;
    ...
    d.SmallMap = d.Class({
        ...
        init: function(a, b) {
            ...
            if (c.enabled) {
                ...
                r = k / 2;
                a.svgIcons ? n.svgIcon = d.line(b, [ - r / 2, 0, r / 2], [ - r / 4, r / 4, -r / 4], c.iconColor, 1, 1) : n.setIcon(a.pathToImages + "arrowDown.gif", k);
    ...
    d.AreasProcessor = d.Class({
        ...
        updateAllAreas: function() {
            ...
            for (n = 0; n < h.length; n++) {
                ...
                if (b.preserveOriginalAttributes) {
                    if (l.customAttr) for (var r in l.customAttr) l.setAttr(r, l.customAttr[r])
                } else {
        ...
        createArea: function(a) {
            ...
            void 0 == l && (l = z);
            z = a.selectedColor;
            void 0 == z && (z = m); (m = a.balloonText) || (m = q);
            ...
            if (c && (r = c.area, A = c.title, a.enTitle = c.title, A && !a.title && (a.title = A), (c = b.language) ? (A = d.mapTranslations) && (c = A[c]) && c[a.enTitle] && (a.titleTr = c[a.enTitle]) : a.titleTr = void 0, r)) {
                ...
                var D;
                void 0 != g && (D = g);
                void 0 != a.colorReal && (D = a.showAsSelected || b.selectedObject == a ? a.selectedColorReal: a.colorReal);
    ...
    d.ImagesProcessor = d.Class({
        ...
        createImage: function(a, b) {
            ...
            void 0 == q && (q = m);
            m = a.selectedColor;
            void 0 == m && (m = r); (r = a.balloonText) || (r = t);
            t = a.outlineColor;
            void 0 == t && (t = p);
            a.outlineColorReal = t;
            p = a.outlineThickness;
            isNaN(p) && (p = y); (y = a.labelPosition) || (y = A);
            A = a.labelColor;
            void 0 == A && (A = w);
            ...
            if (C) {
                ...
                if ("circle" == C || "bubble" == C) q = F;
                B = this.createPredefinedImage(G, t, p, C, F, q);
                u = v = 0;
                a.centeredReal ? (isNaN(a.right) || (v = F * n), isNaN(a.bottom) || (u = q * n)) : (v = F * n / 2, u = q * n / 2);
                B.translate(v, u, n, !0)
            } else z ? (isNaN(F) && (F = 10), isNaN(q) && (q = 10), B = e.image(z, 0, 0, F, q), B.node.setAttribute("preserveAspectRatio", "none"), B.setAttr("opacity", k), a.centeredReal && (v = isNaN(a.right) ? -F / 2 : F / 2, u = isNaN(a.bottom) ? -q / 2 : q / 2, B.translate(v, u, NaN, !0))) : x && (B = e.path(x), t = B.getBBox(), a.centeredReal ? (v = -t.x * n - t.width * n / 2, isNaN(a.right) || (v = -v), u = -t.y * n - t.height * n / 2, isNaN(a.bottom) || (u = -u)) : v = u = 0, B.translate(v, u, n, !0), B.x = v, B.y = u);
            ...
            G = a.labelColorReal; ! a.showAsSelected && c.selectedObject != a || void 0 == h || (B.setAttr("fill", h), G = a.selectedLabelColorReal);
            B = null;
            void 0 !== a.label && (B = d.text(e, a.label, G, c.fontFamily, a.labelFontSizeReal, a.labelAlign), d.setCN(c, B, "map-image-label"), void 0 !== a.id && d.setCN(c, B, "map-image-label-" + a.id), G = a.labelBackgroundAlpha, (k = a.labelBackgroundColor) && 0 < G && (l = B.getBBox(), e = d.rect(e, l.width + 16, l.height + 10, k, G), d.setCN(c, e, "map-image-label-background"), void 0 != a.id && d.setCN(c, e, "map-image-label-background-" + a.id), E.push(e), a.labelBG = e), a.imageLabel = B, E.push(B), d.setCN(c, E, "map-image-container"), void 0 != a.id && d.setCN(c, E, "map-image-container-" + a.id));
            e = isNaN(a.latitude) || isNaN(a.longitude) ? !0 : !1;
            a.lineId && (B = this.chart.getObjectById(a.lineId)) && 0 < B.longitudes.length && (e = !1);
            e ? f.push(E) : g.push(E);
        ...
        updateSizeAndPosition: function(a) {
            ...
            if (a.lineId) {
                var t = this.chart.getObjectById(a.lineId); (a.line = t) && t.getCoordinates && (t.chart = b, t = t.getCoordinates(m, a.lineSegment)) && (k = b.coordinateToLongitude(t.x), l = b.coordinateToLatitude(t.y), f = d.radiansToDegrees(t.angle))
            }
            isNaN(f) || c.rotate(f + a.extraAngle);
            if (!isNaN(e) && !isNaN(g)) c.translate(e, g, NaN, !0);
            else if (!isNaN(l) && !isNaN(k)) if (e = b.longitudeToCoordinate(k), g = b.latitudeToCoordinate(l), a.fixedSize) {
                f = 1;
            ...
            n && (this.labelsToReposition.push(a), a.arrays.push({
    ...
    d.LinesProcessor = d.Class({
        ...
        createLine: function(a, b) {
            ...
            if (a.remainVisible || c.selectedObject == a.parentObject) {
                ...
                void 0 == C && (C = y);
                y = a.selectedColor;
                void 0 == y && (y = z); (z = a.balloonText) || (z = A);
                A = a.arc;
                isNaN(A) && (A = x);
                x = a.arrow;
                ...
                if (0 < w.length) {
                    ...
                    a.distances = [];
                    if (isNaN(n)) {
                        for (n = 0; n < w.length - 1; n++) G = D[n],
                        q = D[n + 1],
                        G = Math.sqrt(Math.pow(w[n + 1] - w[n], 2) + Math.pow(q - G, 2)),
                        a.distances[n] = G;
                    ...
                    if ("none" != x) {
                        var H, K, L;
                        if ("end" == x || "both" == x) p = w[w.length - 1],
                        q = D[D.length - 1],
                        1 < w.length ? (k = w[w.length - 2], H = D[D.length - 2]) : (k = p, H = q),
                        H = 180 * Math.atan((q - H) / (p - k)) / Math.PI,
                        isNaN(E) || (H += E),
                        K = p,
                        L = q,
                        H = 0 > p - k ? H - 90 : H + 90;
                        "both" == x && (p = d.polygon(u, [ - t / 2, 0, t / 2], [1.5 * t, 0, 1.5 * t], m, r, 1, m, r), v.push(p), p.translate(K, L, 1, !0), isNaN(H) || p.rotate(H), d.setCN(c, n, "map-line-arrow"), void 0 != a.id && d.setCN(c, n, "map-line-arrow-" + a.id), a.fixedSize && g.push(p));
                        if ("start" == x || "both" == x) p = w[0],
                        L = D[0],
                        1 < w.length ? (k = w[1], K = D[1]) : (k = p, K = L),
                        H = 180 * Math.atan((L - K) / (p - k)) / Math.PI,
                        isNaN(E) || (H -= E),
                        K = p,
                        H = 0 > p - k ? H - 90 : H + 90;
                        "middle" == x && (p = w[w.length - 1], q = D[D.length - 1], 1 < w.length ? (k = w[w.length - 2], H = D[D.length - 2]) : (k = p, H = q), K = k + (p - k) / 2, L = H + (q - H) / 2, H = 180 * Math.atan((q - H) / (p - k)) / Math.PI, isNaN(E) || (E = G / 2, B -= Math.sqrt(B * B - E * E), 0 > A && (B = -B), E = Math.sin(H / 180 * Math.PI), -1 == E && (E = 1), K -= E * B, L += Math.cos(H / 180 * Math.PI) * B), H = 0 > p - k ? H - 90 : H + 90);
    ...
    d.MapLine = d.Class({
        ...
        getCoordinates: function(a, b) {
            ...
            if (!isNaN(a)) {
                var c, e, g, f, h, k;
                1 < this.longitudes.length ? (c = this.chart.longitudeToCoordinate(this.longitudes[b]), g = this.chart.longitudeToCoordinate(this.longitudes[b + 1]), e = this.chart.latitudeToCoordinate(this.latitudes[b]), f = this.chart.latitudeToCoordinate(this.latitudes[b + 1])) : 1 < this.x.length && (c = this.x[b], g = this.x[b + 1], e = this.y[b], f = this.y[b + 1]);
